...
int main()
{
  ...
  std::cin>>a_y >>b_y;
  std::cout<<" Entrer 0 pour droite 1 pour cercle en translation 2 pour cercle en rotation 3 pour KOTHE"<<
    " 4 cercles imbriqués et 5 pour le cercle coupé en 4 "<<std::endl;
  std::cin>>init;
